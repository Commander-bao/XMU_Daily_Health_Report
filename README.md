#一个时代结束了，一个新的时代开始了，即日起本项目光荣完成其使命，但不会将其删除，如造成后果，本人概不负责 ———— 2022年12月9日
...
## version 1.3.2 修复了打卡失败却发送打卡成功的bug
## 历史版本
#### version 1.3.1 修复了打卡失败发送两份邮件的bug
#### version 1.3.0 增加了打卡失败发送错误信息邮件的功能
